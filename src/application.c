...
#define TMP112_PUB_NO_CHANGE_INTERVAL (2 * 1000)
#define TMP112_PUB_VALUE_CHANGE 0.2f
#define TMP112_UPDATE_INTERVAL (2 * 1000)

#define VOC_LP_TAG_UPDATE_INTERVAL (2 * 1000)
#define VOC_LP_TAG_PUB_VALUE_CHANGE 5.0f
#define VOC_LP_TAG_PUB_NO_CHANGE_INTERVAL (2 * 1000)

#define HUMIDITY_TAG_PUB_NO_CHANGE_INTERVAL (2 * 1000)
